 ...
 *
 */
public class TestClassLeaflets2 {
	...
	private static void generateSeperatePage(ByteArrayOutputStream bout,
		...
		for (int i = 0; i < 2; ++i) {
			...
			pdfdoc.add(title);
			// basic knowledge
			PdfTextBlock basicknow = new PdfTextBlock("（基礎編六回）", 1);
			basicknow.setFontSize(14).setWidthPercentage(88f).adaptPaper(421);
			pdfdoc.add(basicknow);
			// table
			...
			table1.addCell("フマムカタラグてずざるつむじぐそち゛びぐちとむでざるつむじぐそち゛びぐちとむでざるつむじぐそち゛びぐちとむでざるつむじぐそち゛びぐちとむで", 90f, false, 0, 2, 14f, 4);
			...
			table1.setWidthPercentage(90f).setMarginTop(20);
			pdfdoc.add(table1);
			// seperator
	...
	public static void main(String[] args) throws IOException {
		FileOutputStream out = new FileOutputStream("手配リチラシ2.pdf");
