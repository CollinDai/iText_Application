 ...
 *
 */
public class TestClassAttendList1 {
	...
	public static void main(String[] args) throws FileNotFoundException {
		OutputStream out = new FileOutputStream("出席簿.pdf");
		...
		PdfElement[] _text = { pdftit, pdfsign, cls, clsnum, clsname,
				dayperweek, day, clsroom, teacher, tchrnum, time, duration, monthchar, monthchar, monthchar, monthchar, monthchar};
		pdfdoc.headerOrPagenumber(_text, new float[][] { { 10, 7 },
				{ 79.5f, 6f }, { 7, 12 }, { 12.5f, 12 }, { 19.5f, 12 },
				{ 59.5f, 12 }, { 68.5f, 12 }, { 85, 12 }, { 7, 16 },
				{ 16, 16 }, { 59.5f, 16 }, { 68.5f, 16 }, { 38.5f, 20.5f },
