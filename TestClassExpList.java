...
public class TestClassExpList {
	...
	public static void main(String[] args) throws FileNotFoundException {
		FileOutputStream out = new FileOutputStream("体験名簿.pdf");
		...
		// main table
		PdfTable pdftable = new PdfTable(9, new float[]{0.5f, 1.2f, 4.5f, 3.3f, 1.2f, 1.9f, 1f, 1.1f, 1.7f});
		String[] heads = {"", "受付日", "氏　　名", "お電話番号", "受付印", "体験料・教材費", "日付", "受領印", "備考"};
		ArrayList<String> header = new ArrayList<String>();
		for (String e : heads)
			header.add(e);
		pdftable.addHeader(header, 18f);
		// main table content
		String[] testobj = {"／", "", "", "", "￥　", "／", "", ""};
		int objnumber = 25;
