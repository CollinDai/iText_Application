 ...
 *
 */
public class TestClassAttendList2 {
	...
	public static void main(String[] args) throws FileNotFoundException {
		OutputStream out = new FileOutputStream("出席簿2.pdf");
		...
		pdfdoc.headerOrPagenumber(_text, new float[][] { { 10, 7 },
				...
				{ 59.5f, 12 }, { 68.5f, 12 }, { 80, 16 }, { 7, 16 },
				{ 16, 16 }, { 59.5f, 16 }, { 68.5f, 16 }, { 51.5f, 20.5f },
				{ 62.1f, 20.5f }, { 72.7f, 20.5f }, { 83.3f, 20.5f }},
				72f);
		// add table

		PdfTable pdftable = new PdfTable(21, new float[] { 1.3f, 2.2f, 5.3f,
				7.5f, 1f, 1f, 1f, 1f, 1f, 1f, 1f, 1f, 1f,
				1f, 1f, 1f, 1f, 1f, 1f, 1f, 3f });
		String[] heads = { "No.", "会員番号", "氏　　名", "ふ り が な", "", "", "",
				"", "", "", "", "", "", "", "", "", "", "", "", "", "有効年月" };
		...
		// add table contents
		pdftable.setColumnAlignment(new int[] { 5, 5, 5, 5, 5, 1,
				1, 5, 5, 1, 1, 5, 5, 1, 1, 5, 5, 1, 1, 4 });

		int objnumber = 25;

		String[] testobject = { "1284", "劉德華", "アンディラウ", "平成23年15月" };
